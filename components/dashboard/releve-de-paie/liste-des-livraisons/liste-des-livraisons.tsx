        ...
        <>
                                ...
                                <AccordionContent>
                                    <div className="flex flex-col md:flex-row gap-4 p-4 items-start h-full">
                                        <div className="w-full md:w-1/4 bg-gray-100 flex-1 rounded-lg p-4 self-stretch flex flex-col">
                                            <div className=" text-red-500"><span className="flex gap-2 items-center"><User /> Profil</span></div>
                                            <div className="flex-1 flex flex-col items-center justify-center p-4">
                                                <div className="w-16 h-16 bg-purple-500 text-white text-center rounded-full pt-[8%]">
                                                    {("KRAH Éric").charAt(0)}
                                                </div>
                                                ...
                                                <TableHeader>
                                                    <TableRow className="text-red-500">
                                                        <TableHead className="text-left py-2 px-4">
                                                            <span className="flex gap-4 text-red-500"><Calendar size={18} /> Période</span>
                                                        </TableHead>
                                                        <TableHead className="text-left py-2 px-4">
                                                            <span className="flex gap-4 text-red-500"><Home size={18} /> Partenaire</span>
                                                        </TableHead>
                                                        <TableHead className="text-left py-2 px-4">
                                                            <span className="flex gap-4 text-red-500"><ClipboardList size={18} /> Coût de livraison</span>
                                                        </TableHead>
                                                    </TableRow>
                                                </TableHeader>
                                                <TableBody>
                                                    {data.map((item: any, index: number) => (
                                                        <TableRow key={index} className="hover:bg-red-50">
                                                            ...
                                                            <TableCell className="py-2 px-4">
                                                                <Link href={`/${item.id}/releve-de-paie`} passHref>
                                                            ...
                                                            <TableCell className="py-2 px-4">
                                                                <Link href={`/${item.id}/releve-de-paie`}>
                                                                    {item.partenaire}
                                                                </Link>
                                                            </TableCell>
            ...
            <div className="flex justify-between flex-wrap mt-20">
                <div className="flex gap-4">
                    ...
                    <div className="flex gap-4">Net à payer <span className="text-green-500 font-bold flex gap-2"><ArrowUp className="mr-2" /> {data.map((item: any) => {
                        const coutTotal = 0;
