    ...
    <div className="flex flex-col gap-2">
      {data.map((item) => {
        ...
        return (
          ...
          >
            {/* avatar + nom */}
            <div className="flex-shrink-0 flex items-center ww-1/6">
              <div className="w-10 h-10 bg-gray-300 rounded-full mr-3"></div>
              <p className="font-semibold text-slate-500">{item.nomComplet}</p>
            </div>

            {/* date / statut */}
            <div className="flex-shrink-0 ww-1/6 bg-red-500 flex items-center rounded-2xl text-white ppy-2 px-2">{fnData()}</div>

            {/* boutons jours */}
            <div className="flex-shrink-0 ww-2/6 flex items-center gap-2">
              <span>En cours</span>
            ...
            {/* progression */}
            <div className="flex-shrink-0 ww-1/6 flex gap-2 items-center">
              {fnProgressionPerformance(item)}
              <span>Performance {fnPerformance(item)}</span>
            </div>

            {/* commission */}
            <div className="flex-shrink-0 ww-1/12">
              <h3>Commission</h3>
            ...
            {/* actions */}
            <div className="flex-shrink-0 ww-1/7">
