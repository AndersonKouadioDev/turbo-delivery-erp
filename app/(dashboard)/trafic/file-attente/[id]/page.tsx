        ...
        <PageWrapper>
            ...
            <div className='flex justify-start items-center w-full'>
                <div className='flex gap-10tems-center justify-around card border-3 rounded-lg bg-white p-4 w-2/3 '>
                    ...
                    <div>
                        <div className=''>
                            <span className='font-bold text-xl'>Commandes #2555</span><br />
                ...
                <div className='flex gap-4 ml-auto flex-shrink-0'>
                    <Button variant={"success"} className='h-8 rounded-lg'>Écrire à une turbo</Button>
                    <Button variant={"success"} className='h-8 rounded-lg '>Écrire au partenaire</Button>
                    <Button variant={"destructive"} className='h-8 rouded-full'>Signaler une erreur</Button>
                </div>
            </div>
            ...
            <div className="w-full  mt-10">
                ...
                {data.map((item: any) => (
                    <div key={item.id} onClick={() => setActiveRow(item.id)}
                        className={`flex items-center gap-10 p-3 mb-2 rounded-md border cursor-pointer ${actRow === item.id && "bg-orange-300"}`}
                    >
                        <span className={`px-3 py-1 rounded-md border-3`}>
                            {item.rang}
                        </span>
