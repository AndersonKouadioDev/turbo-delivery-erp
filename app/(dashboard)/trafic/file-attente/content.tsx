...
interface Props {
    nbDeliveryMen: number;
    nbPartner: number;
}
export default function Content({ nbDeliveryMen, nbPartner }: Props) {
    return (
        <PageWrapper>
            ...
            <div className="flex gap-4 w-2/3">
                <Card className="card bg-slate-200 box-shadow text-center p-4 w-[35%]">
                    <div className="text-2xl mt-2 ">{nbDeliveryMen} Turboys</div>
                    <Button variant={'destructive'} className="mt-8 w-full text-xl hover:bg-red-300">
                        Voir la liste
                    </Button>
                </Card>
                <Card className="card bg-slate-200 box-shadow text-center p-4 w-[35%]">
                    <div className="text-2xl mt-2">{nbPartner} Partenairs</div>
                    <Button variant={'destructive'} className="mt-8 w-full text-xl hover:bg-red-300">
                        Voir la liste
                    </Button>
                </Card>
