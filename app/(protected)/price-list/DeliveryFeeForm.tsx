...
import { Card, CardBody, CardHeader, Input, Divider, Select, SelectItem } from '@heroui/react';
                ...
                >
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            ...
                            >
                                {[
                                    { label: 'Restaurant 1', value: '1' },
                                    { label: 'Restaurant 2', value: '2' },
                                    { label: 'Restaurant 3', value: '3' },
                                ].map((resto) => (
                                    <SelectItem key={resto.value} value={resto.value}>
                                        {resto.label}
                                    </SelectItem>
                                ))}
                            </Select>
