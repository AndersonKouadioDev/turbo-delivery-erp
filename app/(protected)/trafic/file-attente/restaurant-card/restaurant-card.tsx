                ...
                {fileAttentes &&
                    ...
                    fileAttentes.map((restaurant: FilleAttenteHistoriqueVM) => (
                        <Card
                            ...
                            className={`relative p-4 w-full sm:w-60 h-auto rounded-lg transition-all cursor-pointer shadow-md ${
                                selected === restaurant.restaurantId ? 'bg-gradient-to-r from-orange-500 to-red-500 text-white' : 'bg-gray-200'
                            }`}
